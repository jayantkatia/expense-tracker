          ...
          Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  color: Colors.grey[350], borderRadius: BorderRadius.only(topLeft: Radius.circular(20), topRight: Radius.circular(20))),
            ),
          ),
          SafeArea(
            child: Align(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        DropdownButton(
                          ...
                          iconSize: 30,
                          dropdownColor: Colors.grey[200]?.withOpacity(0.5) ?? Colors.grey,
                          iconDisabledColor: Colors.grey[200],
                          iconEnabledColor: Colors.blue[600],
                          style: TextStyle(
                            color: Colors.blue[600],
